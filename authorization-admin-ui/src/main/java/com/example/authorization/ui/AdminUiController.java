...
public class AdminUiController {
  ...
  public String redirectToIndex() {
    return "redirect:" + normalized(properties.getAdmin().getUi().getBasePath()) + "/";
  }
  ...
  public RuntimeConfig runtimeConfig() {
    return new RuntimeConfig(
        normalized(properties.getAdmin().getApi().getBasePath()),
        normalized(properties.getAdmin().getUi().getBasePath()));
  }
